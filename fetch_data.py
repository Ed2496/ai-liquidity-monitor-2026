...
def generate_html(raw, scores, total, update_time, prov=None):
    prov = prov or {}
...
<div class="update-time">數據自動更新時間：{update_time}（UTC+8）</div>
...
<div class="dim-grid">
  ...
  <div class="dim-card">
    <div class="dim-header">
      ...
      <span class="dim-weight">權重 20%</span>
    </div>
...
def main():
    ...
    html = generate_html(raw, scores, total, update_time, dict(PROVENANCE))
    ...
    print(f"📊 壓力總分: {total}/100")
    print(f"📁 輸出檔案: index.html")
    print("=" * 60)
    print("\n原始數據:")
